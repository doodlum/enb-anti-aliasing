...
public:
	...
	void Upscale(Texture2D* a_color, Texture2D* a_motionVector, Texture2D* a_alphaMask, float2 a_jitter, bool a_reset, sl::DLSSPreset a_preset);
	void UpdateConstants(float2 a_jitter, bool a_reset);
